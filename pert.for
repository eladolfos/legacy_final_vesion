...
C          + km13 f_{u/p}(x2) f_{S/p}(x1) + ...
     ...
     >     +VKM(4,5)*APDFM4*APDFM5
       ...
       U_DB=VKM(1,3)*APDFP1*APDFP3
       DB_U=0.d0
         ELSE IF(iZUZDFLAG.EQ.15) THEN
       U_DB=VKM(1,5)*APDFP1*APDFP5
       DB_U=0.d0
         ELSE IF(iZUZDFLAG.EQ.42) THEN
       U_DB=VKM(4,2)*APDFP4*APDFP2
       DB_U=0.d0
         ELSE IF(iZUZDFLAG.EQ.43) THEN
       U_DB=VKM(4,3)*APDFP4*APDFP3
       DB_U=0.d0
         ELSE IF(iZUZDFLAG.EQ.45) THEN
       U_DB=VKM(4,5)*APDFP4*APDFP5
       DB_U=0.d0
       ...
       DB_U=VKM(1,2)*APDFM1*APDFM2
         ELSE IF(iZUZDFLAG.EQ.-13) THEN
       U_DB=0.d0
       DB_U=VKM(1,3)*APDFM1*APDFM3
         ELSE IF(iZUZDFLAG.EQ.-15) THEN
       U_DB=0.d0
       DB_U=VKM(1,5)*APDFM1*APDFM5
         ELSE IF(iZUZDFLAG.EQ.-42) THEN
       U_DB=0.d0
       DB_U=VKM(4,2)*APDFM4*APDFM2
         ELSE IF(iZUZDFLAG.EQ.-43) THEN
       U_DB=0.d0
       DB_U=VKM(4,3)*APDFM4*APDFM3
         ELSE IF(iZUZDFLAG.EQ.-45) THEN
       U_DB=0.d0
       DB_U=VKM(4,5)*APDFM4*APDFM5
         ENDIF
       ENDIF
...
C          + km13 f_{U/p}(x1) f_{s/p}(x2) + ...
     ...
     >     +VKM(4,5)*APDFM4*APDFM5
       ...
       UB_D=0.d0
         ELSE IF(iZUZDFLAG.EQ.13) THEN
       D_UB=VKM(1,3)*APDFP1*APDFP3
       UB_D=0.d0
         ELSE IF(iZUZDFLAG.EQ.15) THEN
       D_UB=VKM(1,5)*APDFP1*APDFP5
       UB_D=0.d0
         ELSE IF(iZUZDFLAG.EQ.42) THEN
       D_UB=VKM(4,2)*APDFP4*APDFP2
       UB_D=0.d0
         ELSE IF(iZUZDFLAG.EQ.43) THEN
       D_UB=VKM(4,3)*APDFP4*APDFP3
       UB_D=0.d0
         ELSE IF(iZUZDFLAG.EQ.45) THEN
       D_UB=VKM(4,5)*APDFP4*APDFP5
       UB_D=0.d0
         ELSE IF(iZUZDFLAG.EQ.-12) THEN
       D_UB=0.d0
       UB_D=VKM(1,2)*APDFM1*APDFM2
         ELSE IF(iZUZDFLAG.EQ.-13) THEN
       D_UB=0.d0
       UB_D=VKM(1,3)*APDFM1*APDFM3
         ELSE IF(iZUZDFLAG.EQ.-15) THEN
       D_UB=0.d0
       UB_D=VKM(1,5)*APDFM1*APDFM5
         ELSE IF(iZUZDFLAG.EQ.-42) THEN
       D_UB=0.d0
       UB_D=VKM(4,2)*APDFM4*APDFM2
         ELSE IF(iZUZDFLAG.EQ.-43) THEN
       D_UB=0.d0
       UB_D=VKM(4,3)*APDFM4*APDFM3
         ELSE IF(iZUZDFLAG.EQ.-45) THEN
       D_UB=0.d0
       UB_D=VKM(4,5)*APDFM4*APDFM5
         ENDIF
       ENDIF
...
C       U_UB=APDF(1,X1,AMU)*APDF(-1,X2,AMU)
C     >     +APDF(4,X1,AMU)*APDF(-4,X2,AMU)

C       UB_U=APDF(1,X2,AMU)*APDF(-1,X1,AMU)
C     >     +APDF(4,X2,AMU)*APDF(-4,X1,AMU)
...
C_yfu seperate five quarks
     ...
     >     +APDF(4,X2,AMU)*APDF(-4,X1,AMU)
       ELSE
         ...
         U_UB=APDF(4,X1,AMU)*APDF(-4,X2,AMU)
         UB_U=0.d0
         ...
         ELSE IF(iZUZDFLAG.EQ.-4) THEN
         U_UB=0.d0
         UB_U=APDF(4,X2,AMU)*APDF(-4,X1,AMU)
         ENDIF
       ENDIF
...
C       D_DB=APDF(2,X1,AMU)*APDF(-2,X2,AMU)
C     >     +APDF(3,X1,AMU)*APDF(-3,X2,AMU)
C     >     +APDF(5,X1,AMU)*APDF(-5,X2,AMU)

C       DB_D=APDF(2,X2,AMU)*APDF(-2,X1,AMU)
C     >     +APDF(3,X2,AMU)*APDF(-3,X1,AMU)
C     >     +APDF(5,X2,AMU)*APDF(-5,X1,AMU)
...
C_yfu seperate five quarks
     ...
     >     +APDF(5,X2,AMU)*APDF(-5,X1,AMU)
       ELSE
         ...
         D_DB=APDF(3,X1,AMU)*APDF(-3,X2,AMU)
         DB_D=0.d0
         ELSE IF(iZUZDFLAG.EQ.5) THEN
         D_DB=APDF(5,X1,AMU)*APDF(-5,X2,AMU)
         DB_D=0.d0
         ...
         ELSE IF(iZUZDFLAG.EQ.-3) THEN
         D_DB=0.d0
         DB_D=APDF(3,X2,AMU)*APDF(-3,X1,AMU)
         ELSE IF(iZUZDFLAG.EQ.-5) THEN
         D_DB=0.d0
         DB_D=APDF(5,X2,AMU)*APDF(-5,X1,AMU)
         ENDIF
       ENDIF
...
C_yfu seperate five quarks
     ...
     >+APDF(-5,X1,AMU)*(VKM(1,5)+VKM(4,5)) )
       ...
       ELSE
         ...
         IF(iZUZDFLAG.EQ.12) THEN
       U_G_WP=0.d0
       DB_G_WP=APDF(0,X1,AMU)*APDF(-2,X2,AMU)*VKM(1,2)
       U_WP_G=APDF(0,X2,AMU)*APDF(1,X1,AMU)*VKM(1,2)
       DB_WP_G=0.d0
         ELSE IF(iZUZDFLAG.EQ.13) THEN
       U_G_WP=0.d0
       DB_G_WP=APDF(0,X1,AMU)*APDF(-3,X2,AMU)*VKM(1,3)
       U_WP_G=APDF(0,X2,AMU)*APDF(1,X1,AMU)*VKM(1,3)
       DB_WP_G=0.d0
         ELSE IF(iZUZDFLAG.EQ.15) THEN
       U_G_WP=0.d0
       DB_G_WP=APDF(0,X1,AMU)*APDF(-5,X2,AMU)*VKM(1,5)
       U_WP_G=APDF(0,X2,AMU)*APDF(1,X1,AMU)*VKM(1,5)
       DB_WP_G=0.d0
         ELSE IF(iZUZDFLAG.EQ.42) THEN
       U_G_WP=0.d0
       DB_G_WP=APDF(0,X1,AMU)*APDF(-2,X2,AMU)*VKM(4,2)
       U_WP_G=APDF(0,X2,AMU)*APDF(4,X1,AMU)*VKM(4,2)
       DB_WP_G=0.d0
         ELSE IF(iZUZDFLAG.EQ.43) THEN
       U_G_WP=0.d0
       DB_G_WP=APDF(0,X1,AMU)*APDF(-3,X2,AMU)*VKM(4,3)
       U_WP_G=APDF(0,X2,AMU)*APDF(4,X1,AMU)*VKM(4,3)
       DB_WP_G=0.d0
         ELSE IF(iZUZDFLAG.EQ.45) THEN
       U_G_WP=0.d0
       DB_G_WP=APDF(0,X1,AMU)*APDF(-5,X2,AMU)*VKM(4,5)
       U_WP_G=APDF(0,X2,AMU)*APDF(4,X1,AMU)*VKM(4,5)
       DB_WP_G=0.d0
         ELSE IF(iZUZDFLAG.EQ.-12) THEN
       U_G_WP=APDF(0,X1,AMU)*APDF(1,X2,AMU)*VKM(1,2)
       DB_G_WP=0.d0
       U_WP_G=0.d0
       DB_WP_G=APDF(0,X2,AMU)*APDF(-2,X1,AMU)*VKM(1,2)
         ELSE IF(iZUZDFLAG.EQ.-13) THEN
       U_G_WP=APDF(0,X1,AMU)*APDF(1,X2,AMU)*VKM(1,3)
       DB_G_WP=0.d0
       U_WP_G=0.d0
       DB_WP_G=APDF(0,X2,AMU)*APDF(-3,X1,AMU)*VKM(1,3)
         ELSE IF(iZUZDFLAG.EQ.-15) THEN
       U_G_WP=APDF(0,X1,AMU)*APDF(1,X2,AMU)*VKM(1,5)
       DB_G_WP=0.d0
       U_WP_G=0.d0
       DB_WP_G=APDF(0,X2,AMU)*APDF(-5,X1,AMU)*VKM(1,5)
         ELSE IF(iZUZDFLAG.EQ.-42) THEN
       U_G_WP=APDF(0,X1,AMU)*APDF(4,X2,AMU)*VKM(4,2)
       DB_G_WP=0.d0
       U_WP_G=0.d0
       DB_WP_G=APDF(0,X2,AMU)*APDF(-2,X1,AMU)*VKM(4,2)
         ELSE IF(iZUZDFLAG.EQ.-43) THEN
       U_G_WP=APDF(0,X1,AMU)*APDF(4,X2,AMU)*VKM(4,3)
       DB_G_WP=0.d0
       U_WP_G=0.d0
       DB_WP_G=APDF(0,X2,AMU)*APDF(-3,X1,AMU)*VKM(4,3)
         ELSE IF(iZUZDFLAG.EQ.-45) THEN
       U_G_WP=APDF(0,X1,AMU)*APDF(4,X2,AMU)*VKM(4,5)
       DB_G_WP=0.d0
       U_WP_G=0.d0
       DB_WP_G=APDF(0,X2,AMU)*APDF(-5,X1,AMU)*VKM(4,5)
         ENDIF
       ENDIF
...
C_yfu seperate five quarks
     ...
     >+APDF(5,X1,AMU)*(VKM(1,5)+VKM(4,5)) )
       ...
       ELSE
         READ (envZUZDFLAG,*) iZUZDFLAG
         IF(iZUZDFLAG.EQ.12) THEN
       UB_G_WM=APDF(0,X1,AMU)*APDF(-1,X2,AMU)*VKM(1,2)
       D_G_WM=0.d0
       UB_WM_G=0.d0
       D_WM_G=APDF(0,X2,AMU)*APDF(2,X1,AMU)*VKM(1,2)
         ELSE IF(iZUZDFLAG.EQ.13) THEN
       UB_G_WM=APDF(0,X1,AMU)*APDF(-1,X2,AMU)*VKM(1,3)
       D_G_WM=0.d0
       UB_WM_G=0.d0
       D_WM_G=APDF(0,X2,AMU)*APDF(3,X1,AMU)*VKM(1,3)
         ELSE IF(iZUZDFLAG.EQ.15) THEN
       UB_G_WM=APDF(0,X1,AMU)*APDF(-1,X2,AMU)*VKM(1,5)
       D_G_WM=0.d0
       UB_WM_G=0.d0
       D_WM_G=APDF(0,X2,AMU)*APDF(5,X1,AMU)*VKM(1,5)
         ELSE IF(iZUZDFLAG.EQ.42) THEN
       UB_G_WM=APDF(0,X1,AMU)*APDF(-4,X2,AMU)*VKM(4,2)
       D_G_WM=0.d0
       UB_WM_G=0.d0
       D_WM_G=APDF(0,X2,AMU)*APDF(2,X1,AMU)*VKM(4,2)
         ELSE IF(iZUZDFLAG.EQ.43) THEN
       UB_G_WM=APDF(0,X1,AMU)*APDF(-4,X2,AMU)*VKM(4,3)
       D_G_WM=0.d0
       UB_WM_G=0.d0
       D_WM_G=APDF(0,X2,AMU)*APDF(3,X1,AMU)*VKM(4,3)
         ELSE IF(iZUZDFLAG.EQ.45) THEN
       UB_G_WM=APDF(0,X1,AMU)*APDF(-4,X2,AMU)*VKM(4,5)
       D_G_WM=0.d0
       UB_WM_G=0.d0
       D_WM_G=APDF(0,X2,AMU)*APDF(5,X1,AMU)*VKM(4,5)
         ELSE IF(iZUZDFLAG.EQ.-12) THEN
       UB_G_WM=0.d0
       D_G_WM=APDF(0,X1,AMU)*APDF(2,X2,AMU)*VKM(1,2)
       UB_WM_G=APDF(0,X2,AMU)*APDF(-1,X1,AMU)*VKM(1,2)
       D_WM_G=0.d0
         ELSE IF(iZUZDFLAG.EQ.-13) THEN
       UB_G_WM=0.d0
       D_G_WM=APDF(0,X1,AMU)*APDF(3,X2,AMU)*VKM(1,3)
       UB_WM_G=APDF(0,X2,AMU)*APDF(-1,X1,AMU)*VKM(1,3)
       D_WM_G=0.d0
         ELSE IF(iZUZDFLAG.EQ.-15) THEN
       UB_G_WM=0.d0
       D_G_WM=APDF(0,X1,AMU)*APDF(5,X2,AMU)*VKM(1,5)
       UB_WM_G=APDF(0,X2,AMU)*APDF(-1,X1,AMU)*VKM(1,5)
       D_WM_G=0.d0
         ELSE IF(iZUZDFLAG.EQ.-42) THEN
       UB_G_WM=0.d0
       D_G_WM=APDF(0,X1,AMU)*APDF(2,X2,AMU)*VKM(4,2)
       UB_WM_G=APDF(0,X2,AMU)*APDF(-4,X1,AMU)*VKM(4,2)
       D_WM_G=0.d0
         ELSE IF(iZUZDFLAG.EQ.-43) THEN
       UB_G_WM=0.d0
       D_G_WM=APDF(0,X1,AMU)*APDF(3,X2,AMU)*VKM(4,3)
       UB_WM_G=APDF(0,X2,AMU)*APDF(-4,X1,AMU)*VKM(4,3)
       D_WM_G=0.d0
         ELSE IF(iZUZDFLAG.EQ.-45) THEN
       UB_G_WM=0.d0
       D_G_WM=APDF(0,X1,AMU)*APDF(5,X2,AMU)*VKM(4,5)
       UB_WM_G=APDF(0,X2,AMU)*APDF(-4,X1,AMU)*VKM(4,5)
       D_WM_G=0.d0
         ENDIF
       ENDIF
...
C_yfu
C       G_Q_Z=APDF(0,X1,AMU)*(
C     > APDF(1,X2,AMU)*ZFF2(1)+APDF(4,X2,AMU)*ZFF2(4) )

C       G_QB_Z=APDF(0,X1,AMU)*(
C     > APDF(-1,X2,AMU)*ZFF2(1)+APDF(-4,X2,AMU)*ZFF2(4) )

C       Q_G_Z=APDF(0,X2,AMU)*(
C     > APDF(1,X1,AMU)*ZFF2(1)+APDF(4,X1,AMU)*ZFF2(4) )
...
C     > APDF(-1,X1,AMU)*ZFF2(1)+APDF(-4,X1,AMU)*ZFF2(4) )
     ...
     > APDF(-1,X1,AMU)*ZFF2(1)+APDF(-4,X1,AMU)*ZFF2(4) )
       ...
       G_QB_Z=APDF(0,X1,AMU)*(
     > APDF(-1,X2,AMU)*ZFF2(1) )

       Q_G_Z=APDF(0,X2,AMU)*(
     > APDF(1,X1,AMU)*ZFF2(1))
       ...
       G_QB_Z=APDF(0,X1,AMU)*(
     > APDF(-4,X2,AMU)*ZFF2(4) )

       Q_G_Z=APDF(0,X2,AMU)*(
     > APDF(4,X1,AMU)*ZFF2(4) )
...
C_yfu seperate five quarks
C       G_Q_Z=APDF(0,X1,AMU)*(
C     >+APDF(2,X2,AMU)*ZFF2(2)+APDF(3,X2,AMU)*ZFF2(3)
C     >+APDF(5,X2,AMU)*ZFF2(5) )
...
C       Q_G_Z=APDF(0,X2,AMU)*(
C     >+APDF(2,X1,AMU)*ZFF2(2)+APDF(3,X1,AMU)*ZFF2(3)
C     >+APDF(5,X1,AMU)*ZFF2(5) )
...
C     >+APDF(-5,X1,AMU)*ZFF2(5) )
     ...
     >+APDF(-5,X1,AMU)*ZFF2(5) )
       ...
       G_QB_Z=APDF(0,X1,AMU)*(
     > APDF(-2,X2,AMU)*ZFF2(2) )

       Q_G_Z=APDF(0,X2,AMU)*(
     > APDF(2,X1,AMU)*ZFF2(2) )
       ...
       G_QB_Z=APDF(0,X1,AMU)*(
     > APDF(-3,X2,AMU)*ZFF2(3) )

       Q_G_Z=APDF(0,X2,AMU)*(
     > APDF(3,X1,AMU)*ZFF2(3) )
...
C_yfu seperate five quarks
     ...
     >     +vkm(4,5)*splitm4*apdfm5
       ...
       db_u=0.d0
         ELSE IF(iZUZDFLAG.EQ.13) THEN
       u_db=vkm(1,3)*splitp1*apdfp3
       db_u=0.d0
         ELSE IF(iZUZDFLAG.EQ.15) THEN
       u_db=vkm(1,5)*splitp1*apdfp5
       db_u=0.d0
         ELSE IF(iZUZDFLAG.EQ.42) THEN
       u_db=vkm(4,2)*splitp4*apdfp2
       db_u=0.d0
         ELSE IF(iZUZDFLAG.EQ.43) THEN
       u_db=vkm(4,3)*splitp4*apdfp3
       db_u=0.d0
         ELSE IF(iZUZDFLAG.EQ.45) THEN
       u_db=vkm(4,5)*splitp4*apdfp5
       db_u=0.d0
         ELSE IF(iZUZDFLAG.EQ.-12) THEN
       u_db=0.d0
       db_u=vkm(1,2)*splitm1*apdfm2
         ELSE IF(iZUZDFLAG.EQ.-13) THEN
       u_db=0.d0
       db_u=vkm(1,3)*splitm1*apdfm3
         ELSE IF(iZUZDFLAG.EQ.-15) THEN
       u_db=0.d0
       db_u=vkm(1,5)*splitm1*apdfm5
         ELSE IF(iZUZDFLAG.EQ.-42) THEN
       u_db=0.d0
       db_u=vkm(4,2)*splitm4*apdfm2
         ELSE IF(iZUZDFLAG.EQ.-43) THEN
       u_db=0.d0
       db_u=vkm(4,3)*splitm4*apdfm3
         ELSE IF(iZUZDFLAG.EQ.-45) THEN
       u_db=0.d0
       db_u=vkm(4,5)*splitm4*apdfm5
         ENDIF
       ENDIF
...
C_yfu seperate five quarks
     ...
     >     +vkm(4,5)*splitm4*apdfm5
       ...
       db_u_2=0.d0
         ELSE IF(iZUZDFLAG.EQ.13) THEN
       u_db_2=vkm(1,3)*splitp1*apdfp3
       db_u_2=0.d0
         ELSE IF(iZUZDFLAG.EQ.15) THEN
       u_db_2=vkm(1,5)*splitp1*apdfp5
       db_u_2=0.d0
         ELSE IF(iZUZDFLAG.EQ.42) THEN
       u_db_2=vkm(4,2)*splitp4*apdfp2
       db_u_2=0.d0
         ELSE IF(iZUZDFLAG.EQ.43) THEN
       u_db_2=vkm(4,3)*splitp4*apdfp3
       db_u_2=0.d0
         ELSE IF(iZUZDFLAG.EQ.45) THEN
       u_db_2=vkm(4,5)*splitp4*apdfp5
       db_u_2=0.d0
         ELSE IF(iZUZDFLAG.EQ.-12) THEN
       u_db_2=0.d0
       db_u_2=vkm(1,2)*splitm1*apdfm2
         ELSE IF(iZUZDFLAG.EQ.-13) THEN
       u_db_2=0.d0
       db_u_2=vkm(1,3)*splitm1*apdfm3
         ELSE IF(iZUZDFLAG.EQ.-15) THEN
       u_db_2=0.d0
       db_u_2=vkm(1,5)*splitm1*apdfm5
         ELSE IF(iZUZDFLAG.EQ.-42) THEN
       u_db_2=0.d0
       db_u_2=vkm(4,2)*splitm4*apdfm2
         ELSE IF(iZUZDFLAG.EQ.-43) THEN
       u_db_2=0.d0
       db_u_2=vkm(4,3)*splitm4*apdfm3
         ELSE IF(iZUZDFLAG.EQ.-45) THEN
       u_db_2=0.d0
       db_u_2=vkm(4,5)*splitm4*apdfm5
         ENDIF
       ENDIF
...
C_yfu seperate five quarks
     ...
     >     +vkm(4,5)*splitm4*apdfm5
       ...
       ub_d=0.d0
         ELSE IF(iZUZDFLAG.EQ.13) THEN
       d_ub=vkm(1,3)*splitp1*apdfp3
       ub_d=0.d0
         ELSE IF(iZUZDFLAG.EQ.15) THEN
       d_ub=vkm(1,5)*splitp1*apdfp5
       ub_d=0.d0
         ELSE IF(iZUZDFLAG.EQ.42) THEN
       d_ub=vkm(4,2)*splitp4*apdfp2
       ub_d=0.d0
         ELSE IF(iZUZDFLAG.EQ.43) THEN
       d_ub=vkm(4,3)*splitp4*apdfp3
       ub_d=0.d0
         ELSE IF(iZUZDFLAG.EQ.45) THEN
       d_ub=vkm(4,5)*splitp4*apdfp5
       ub_d=0.d0
         ELSE IF(iZUZDFLAG.EQ.-12) THEN
       d_ub=0.d0
       ub_d=vkm(1,2)*splitm1*apdfm2
         ELSE IF(iZUZDFLAG.EQ.-13) THEN
       d_ub=0.d0
       ub_d=vkm(1,3)*splitm1*apdfm3
         ELSE IF(iZUZDFLAG.EQ.-15) THEN
       d_ub=0.d0
       ub_d=vkm(1,5)*splitm1*apdfm5
         ELSE IF(iZUZDFLAG.EQ.-42) THEN
       d_ub=0.d0
       ub_d=vkm(4,2)*splitm4*apdfm2
         ELSE IF(iZUZDFLAG.EQ.-43) THEN
       d_ub=0.d0
       ub_d=vkm(4,3)*splitm4*apdfm3
         ELSE IF(iZUZDFLAG.EQ.-45) THEN
       d_ub=0.d0
       ub_d=vkm(4,5)*splitm4*apdfm5
         ENDIF
       ENDIF
...
C_yfu seperate five quarks
     ...
     >     +vkm(4,5)*splitm4*apdfm5
       ...
       ub_d_2=0.d0
         ELSE IF(iZUZDFLAG.EQ.13) THEN
       d_ub_2=vkm(1,3)*splitp1*apdfp3
       ub_d_2=0.d0
         ELSE IF(iZUZDFLAG.EQ.15) THEN
       d_ub_2=vkm(1,5)*splitp1*apdfp5
       ub_d_2=0.d0
         ELSE IF(iZUZDFLAG.EQ.42) THEN
       d_ub_2=vkm(4,2)*splitp4*apdfp2
       ub_d_2=0.d0
         ELSE IF(iZUZDFLAG.EQ.43) THEN
       d_ub_2=vkm(4,3)*splitp4*apdfp3
       ub_d_2=0.d0
         ELSE IF(iZUZDFLAG.EQ.45) THEN
       d_ub_2=vkm(4,5)*splitp4*apdfp5
       ub_d_2=0.d0
         ELSE IF(iZUZDFLAG.EQ.-12) THEN
       d_ub_2=0.d0
       ub_d_2=vkm(1,2)*splitm1*apdfm2
         ELSE IF(iZUZDFLAG.EQ.-13) THEN
       d_ub_2=0.d0
       ub_d_2=vkm(1,3)*splitm1*apdfm3
         ELSE IF(iZUZDFLAG.EQ.-15) THEN
       d_ub_2=0.d0
       ub_d_2=vkm(1,5)*splitm1*apdfm5
         ELSE IF(iZUZDFLAG.EQ.-42) THEN
       d_ub_2=0.d0
       ub_d_2=vkm(4,2)*splitm4*apdfm2
         ELSE IF(iZUZDFLAG.EQ.-43) THEN
       d_ub_2=0.d0
       ub_d_2=vkm(4,3)*splitm4*apdfm3
         ELSE IF(iZUZDFLAG.EQ.-45) THEN
       d_ub_2=0.d0
       ub_d_2=vkm(4,5)*splitm4*apdfm5
         ENDIF
       ENDIF
...
c -----------------
     ...
     > type_v.eq. 'A0' .or. type_v .eq. 'Z0' .or.
     > type_v.eq.'aa' .or. type_v.eq.'zz' .or.
     > type_v.eq.'hz' .or. type_v.eq.'gl' ) then
...
C       u_ub=splitsud(1,a_x_a,amu)*apdf(-1,a_x_b,amu)
C     >     +splitsud(4,a_x_a,amu)*apdf(-4,a_x_b,amu)

C       ub_u=splitsud(1,a_x_b,amu)*apdf(-1,a_x_a,amu)
C     >     +splitsud(4,a_x_b,amu)*apdf(-4,a_x_a,amu)

C       u_ub_2=apdf(1,a_x_a,amu)*splitsud(-1,a_x_b,amu)
C     >     +apdf(4,a_x_a,amu)*splitsud(-4,a_x_b,amu)

C       ub_u_2=apdf(1,a_x_b,amu)*splitsud(-1,a_x_a,amu)
C     >     +apdf(4,a_x_b,amu)*splitsud(-4,a_x_a,amu)
...
C_yfu seperate five quarks
     ...
     >     +apdf(4,a_x_b,amu)*splitsud(-4,a_x_a,amu)
       ...
       ub_u_2=0.d0
         ELSE IF(iZUZDFLAG.EQ.4) THEN
       u_ub=splitsud(4,a_x_a,amu)*apdf(-4,a_x_b,amu)
       ub_u=0.d0
       u_ub_2=apdf(4,a_x_a,amu)*splitsud(-4,a_x_b,amu)
       ub_u_2=0.d0
         ELSE IF(iZUZDFLAG.EQ.-1) THEN
       u_ub=0.d0
       ub_u=splitsud(1,a_x_b,amu)*apdf(-1,a_x_a,amu)
       ...
       ub_u_2=apdf(1,a_x_b,amu)*splitsud(-1,a_x_a,amu)
         ELSE IF(iZUZDFLAG.EQ.-4) THEN
       u_ub=0.d0
       ub_u=splitsud(4,a_x_b,amu)*apdf(-4,a_x_a,amu)
       u_ub_2=0.d0
       ub_u_2=apdf(4,a_x_b,amu)*splitsud(-4,a_x_a,amu)
         ENDIF
       ENDIF
...
C       d_db=splitsud(2,a_x_a,amu)*apdf(-2,a_x_b,amu)
C     >     +splitsud(3,a_x_a,amu)*apdf(-3,a_x_b,amu)
C     >     +splitsud(5,a_x_a,amu)*apdf(-5,a_x_b,amu)

C       db_d=splitsud(2,a_x_b,amu)*apdf(-2,a_x_a,amu)
C     >     +splitsud(3,a_x_b,amu)*apdf(-3,a_x_a,amu)
C     >     +splitsud(5,a_x_b,amu)*apdf(-5,a_x_a,amu)

C       d_db_2=apdf(2,a_x_a,amu)*splitsud(-2,a_x_b,amu)
C     >     +apdf(3,a_x_a,amu)*splitsud(-3,a_x_b,amu)
C     >     +apdf(5,a_x_a,amu)*splitsud(-5,a_x_b,amu)

C       db_d_2=apdf(2,a_x_b,amu)*splitsud(-2,a_x_a,amu)
C     >     +apdf(3,a_x_b,amu)*splitsud(-3,a_x_a,amu)
C     >     +apdf(5,a_x_b,amu)*splitsud(-5,a_x_a,amu)
...
C_yfu seperate five quarks
     ...
     >     +apdf(5,a_x_b,amu)*splitsud(-5,a_x_a,amu)
       ...
       db_d_2=0.d0
         ELSE IF(iZUZDFLAG.EQ.3) THEN
       d_db=splitsud(3,a_x_a,amu)*apdf(-3,a_x_b,amu)
       db_d=0.d0
       d_db_2=apdf(3,a_x_a,amu)*splitsud(-3,a_x_b,amu)
       db_d_2=0.d0
         ELSE IF(iZUZDFLAG.EQ.5) THEN
       d_db=splitsud(5,a_x_a,amu)*apdf(-5,a_x_b,amu)
       db_d=0.d0
       d_db_2=apdf(5,a_x_a,amu)*splitsud(-5,a_x_b,amu)
       db_d_2=0.d0
         ELSE IF(iZUZDFLAG.EQ.-2) THEN
       d_db=0.d0
       db_d=splitsud(2,a_x_b,amu)*apdf(-2,a_x_a,amu)
       ...
       db_d_2=apdf(2,a_x_b,amu)*splitsud(-2,a_x_a,amu)
         ELSE IF(iZUZDFLAG.EQ.-3) THEN
       d_db=0.d0
       db_d=splitsud(3,a_x_b,amu)*apdf(-3,a_x_a,amu)
       d_db_2=0.d0
       db_d_2=apdf(3,a_x_b,amu)*splitsud(-3,a_x_a,amu)
         ELSE IF(iZUZDFLAG.EQ.-5) THEN
       d_db=0.d0
       db_d=splitsud(5,a_x_b,amu)*apdf(-5,a_x_a,amu)
       d_db_2=0.d0
       db_d_2=apdf(5,a_x_b,amu)*splitsud(-5,a_x_a,amu)
         ENDIF
       ENDIF
...
C_yfu seperate five quarks
     ...
     >+apdf(-5,x1,amu)*(vkm(1,5)+vkm(4,5)) )
       ...
       ELSE
         ...
         IF(iZUZDFLAG.EQ.12) THEN
       u_g_wp=0.d0
       db_g_wp=splitsud(0,x1,amu)*apdf(-2,x2,amu)*vkm(1,2)
       u_wp_g=splitsud(0,x2,amu)*apdf(1,x1,amu)*vkm(1,2)
       db_wp_g=0.d0
         ELSE IF(iZUZDFLAG.EQ.13) THEN
       u_g_wp=0.d0
       db_g_wp=splitsud(0,x1,amu)*apdf(-3,x2,amu)*vkm(1,3)
       u_wp_g=splitsud(0,x2,amu)*apdf(1,x1,amu)*vkm(1,3)
       db_wp_g=0.d0
         ELSE IF(iZUZDFLAG.EQ.15) THEN
       u_g_wp=0.d0
       db_g_wp=splitsud(0,x1,amu)*apdf(-5,x2,amu)*vkm(1,5)
       u_wp_g=splitsud(0,x2,amu)*apdf(1,x1,amu)*vkm(1,5)
       db_wp_g=0.d0
         ELSE IF(iZUZDFLAG.EQ.42) THEN
       u_g_wp=0.d0
       db_g_wp=splitsud(0,x1,amu)*apdf(-2,x2,amu)*vkm(4,2)
       u_wp_g=splitsud(0,x2,amu)*apdf(4,x1,amu)*vkm(4,2)
       db_wp_g=0.d0
         ELSE IF(iZUZDFLAG.EQ.43) THEN
       u_g_wp=0.d0
       db_g_wp=splitsud(0,x1,amu)*apdf(-3,x2,amu)*vkm(4,3)
       u_wp_g=splitsud(0,x2,amu)*apdf(4,x1,amu)*vkm(4,3)
       db_wp_g=0.d0
         ELSE IF(iZUZDFLAG.EQ.45) THEN
       u_g_wp=0.d0
       db_g_wp=splitsud(0,x1,amu)*apdf(-5,x2,amu)*vkm(4,5)
       u_wp_g=splitsud(0,x2,amu)*apdf(4,x1,amu)*vkm(4,5)
       db_wp_g=0.d0
         ELSE IF(iZUZDFLAG.EQ.-12) THEN
       u_g_wp=splitsud(0,x1,amu)*apdf(1,x2,amu)*vkm(1,2)
       db_g_wp=0.d0
       u_wp_g=0.d0
       db_wp_g=splitsud(0,x2,amu)*apdf(-2,x1,amu)*vkm(1,2)
         ELSE IF(iZUZDFLAG.EQ.-13) THEN
       u_g_wp=splitsud(0,x1,amu)*apdf(1,x2,amu)*vkm(1,3)
       db_g_wp=0.d0
       u_wp_g=0.d0
       db_wp_g=splitsud(0,x2,amu)*apdf(-3,x1,amu)*vkm(1,3)
         ELSE IF(iZUZDFLAG.EQ.-15) THEN
       u_g_wp=splitsud(0,x1,amu)*apdf(1,x2,amu)*vkm(1,5)
       db_g_wp=0.d0
       u_wp_g=0.d0
       db_wp_g=splitsud(0,x2,amu)*apdf(-5,x1,amu)*vkm(1,5)
         ELSE IF(iZUZDFLAG.EQ.-42) THEN
       u_g_wp=splitsud(0,x1,amu)*apdf(4,x2,amu)*vkm(4,2)
       db_g_wp=0.d0
       u_wp_g=0.d0
       db_wp_g=splitsud(0,x2,amu)*apdf(-2,x1,amu)*vkm(4,2)
         ELSE IF(iZUZDFLAG.EQ.-43) THEN
       u_g_wp=splitsud(0,x1,amu)*apdf(4,x2,amu)*vkm(4,3)
       db_g_wp=0.d0
       u_wp_g=0.d0
       db_wp_g=splitsud(0,x2,amu)*apdf(-3,x1,amu)*vkm(4,3)
         ELSE IF(iZUZDFLAG.EQ.-45) THEN
       u_g_wp=splitsud(0,x1,amu)*apdf(4,x2,amu)*vkm(4,5)
       db_g_wp=0.d0
       u_wp_g=0.d0
       db_wp_g=splitsud(0,x2,amu)*apdf(-5,x1,amu)*vkm(4,5)
         ENDIF
       ENDIF
...
C_yfu seperate five quarks
     ...
     >+apdf(5,x1,amu)*(vkm(1,5)+vkm(4,5)) )
       ...
       ELSE
         READ (envZUZDFLAG,*) iZUZDFLAG
         IF(iZUZDFLAG.EQ.12) THEN
       ub_g_wm=splitsud(0,x1,amu)*apdf(-1,x2,amu)*vkm(1,2)
       d_g_wm=0.d0
       ub_wm_g=0.d0
       d_wm_g=splitsud(0,x2,amu)*apdf(2,x1,amu)*vkm(1,2)
         ELSE IF(iZUZDFLAG.EQ.13) THEN
       ub_g_wm=splitsud(0,x1,amu)*apdf(-1,x2,amu)*vkm(1,3)
       d_g_wm=0.d0
       ub_wm_g=0.d0
       d_wm_g=splitsud(0,x2,amu)*apdf(3,x1,amu)*vkm(1,3)
         ELSE IF(iZUZDFLAG.EQ.15) THEN
       ub_g_wm=splitsud(0,x1,amu)*apdf(-1,x2,amu)*vkm(1,5)
       d_g_wm=0.d0
       ub_wm_g=0.d0
       d_wm_g=splitsud(0,x2,amu)*apdf(5,x1,amu)*vkm(1,5)
         ELSE IF(iZUZDFLAG.EQ.42) THEN
       ub_g_wm=splitsud(0,x1,amu)*apdf(-4,x2,amu)*vkm(4,2)
       d_g_wm=0.d0
       ub_wm_g=0.d0
       d_wm_g=splitsud(0,x2,amu)*apdf(2,x1,amu)*vkm(4,2)
         ELSE IF(iZUZDFLAG.EQ.43) THEN
       ub_g_wm=splitsud(0,x1,amu)*apdf(-4,x2,amu)*vkm(4,3)
       d_g_wm=0.d0
       ub_wm_g=0.d0
       d_wm_g=splitsud(0,x2,amu)*apdf(3,x1,amu)*vkm(4,3)
         ELSE IF(iZUZDFLAG.EQ.45) THEN
       ub_g_wm=splitsud(0,x1,amu)*apdf(-4,x2,amu)*vkm(4,5)
       d_g_wm=0.d0
       ub_wm_g=0.d0
       d_wm_g=splitsud(0,x2,amu)*apdf(5,x1,amu)*vkm(4,5)
         ELSE IF(iZUZDFLAG.EQ.-12) THEN
       ub_g_wm=0.d0
       d_g_wm=splitsud(0,x1,amu)*apdf(2,x2,amu)*vkm(1,2)
       ub_wm_g=splitsud(0,x2,amu)*apdf(-1,x1,amu)*vkm(1,2)
       d_wm_g=0.d0
         ELSE IF(iZUZDFLAG.EQ.-13) THEN
       ub_g_wm=0.d0
       d_g_wm=splitsud(0,x1,amu)*apdf(3,x2,amu)*vkm(1,3)
       ub_wm_g=splitsud(0,x2,amu)*apdf(-1,x1,amu)*vkm(1,3)
       d_wm_g=0.d0
         ELSE IF(iZUZDFLAG.EQ.-15) THEN
       ub_g_wm=0.d0
       d_g_wm=splitsud(0,x1,amu)*apdf(5,x2,amu)*vkm(1,5)
       ub_wm_g=splitsud(0,x2,amu)*apdf(-1,x1,amu)*vkm(1,5)
       d_wm_g=0.d0
         ELSE IF(iZUZDFLAG.EQ.-42) THEN
       ub_g_wm=0.d0
       d_g_wm=splitsud(0,x1,amu)*apdf(2,x2,amu)*vkm(4,2)
       ub_wm_g=splitsud(0,x2,amu)*apdf(-4,x1,amu)*vkm(4,2)
       d_wm_g=0.d0
         ELSE IF(iZUZDFLAG.EQ.-43) THEN
       ub_g_wm=0.d0
       d_g_wm=splitsud(0,x1,amu)*apdf(3,x2,amu)*vkm(4,3)
       ub_wm_g=splitsud(0,x2,amu)*apdf(-4,x1,amu)*vkm(4,3)
       d_wm_g=0.d0
         ELSE IF(iZUZDFLAG.EQ.-45) THEN
       ub_g_wm=0.d0
       d_g_wm=splitsud(0,x1,amu)*apdf(5,x2,amu)*vkm(4,5)
       ub_wm_g=splitsud(0,x2,amu)*apdf(-4,x1,amu)*vkm(4,5)
       d_wm_g=0.d0
         ENDIF
       ENDIF
...
C       g_q_z = splitsud(0,x1,amu)*(
C     > (apdf(1,x2,amu))*zff2(1)+(apdf(4,x2,amu))*zff2(4) )

C       g_qb_z = splitsud(0,x1,amu)*(
C     > (apdf(-1,x2,amu))*zff2(1)+(apdf(-4,x2,amu))*zff2(4) )
